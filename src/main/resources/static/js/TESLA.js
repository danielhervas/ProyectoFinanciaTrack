...
function calcularCambioTSLA(precioActual, precioAnterior) {
...
function crearCardTSLA(datos) {
    ...
    logo.src = "/assets/img/tesla.jpg";  // logo
    ...
    button.addEventListener("click", () => {
        window.location.href = "https://es.tradingview.com/symbols/NASDAQ-TSLA/";
    });
    ...
    document.getElementById("cardContainer6").appendChild(card);
}

// Ejecuta la obtención de datos y creación de la card
(async () => {
    const datos = await obtenerDatosTSLA();
