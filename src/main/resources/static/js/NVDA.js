    ...
    function calcularCambio(precioActual, precioAnterior) {
    ...
    logo.src = "/assets/img/logo_nvda.jpg";  // logo
    ...
    button.addEventListener("click", () => {
        window.location.href = "https://es.tradingview.com/symbols/NASDAQ-NVDA/";
    });
