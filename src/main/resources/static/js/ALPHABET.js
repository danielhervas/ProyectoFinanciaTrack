...
function calcularCambioGOOG(precioActual, precioAnterior) {
...
function crearCardGOOG(datos) {
    ...
    logo.src = "/assets/img/google.png";  // logo
    ...
    button.addEventListener("click", () => {
        window.location.href = "https://es.tradingview.com/symbols/NASDAQ-GOOG/";
    });
    ...
    document.getElementById("cardContainer5").appendChild(card);
}

// Ejecuta la obtención de datos y creación de la card
(async () => {
    const datos = await obtenerDatosGOOG();
